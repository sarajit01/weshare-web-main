...
@Component({
  selector: 'app-debit-customer-reward',
  templateUrl: './debit-customer-reward.component.html',
  styleUrls: ['./debit-customer-reward.component.css']
})
export class DebitCustomerRewardComponent implements OnInit {
  ...
  async submitData() {
    ...
    try {
      ...
      const resp = await this.listingService.saveCustomerReward(this.form.value).toPromise();
      console.log(resp);
