...
@Component({
  selector: 'app-simple-img-carousel-v2',
  templateUrl: './simple-img-carousel-v2.component.html',
  styleUrls: ['./simple-img-carousel-v2.component.css']
})
export class SimpleImgCarouselV2Component implements OnInit {
