...
import {BusinessDetailComponent, Vegetable} from "../business-detail/business-detail.component";
...
@Component({
  selector: 'app-business-detail-simulate-preview',
  templateUrl: './business-detail-simulate-preview.component.html',
  styleUrls: ['./business-detail-simulate-preview.component.css']
})
export class BusinessDetailSimulatePreviewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.businessDetails){
      ...
      console.log('Fetched in simulator');
